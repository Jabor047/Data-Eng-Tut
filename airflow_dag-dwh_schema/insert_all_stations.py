...
with DAG(dag_id="insert_all_station_data",default_args=default_args, schedule_interval='@once', tags=['mysql','connector', 'dwh', 'station']) as dag:
    
    pre_process = PythonOperator(
        task_id = "pre_process",
        python_callable = preprocess_stations,
        op_kwargs={'path': '/home/Abuton/Desktop/ML_PATH/week0/dwh-techstack/Data-Eng-Tut/I80_davis_csv/part-00000-ed553926-4a23-4a83-b890-aa071edb86ea-c000.csv'}
        )
