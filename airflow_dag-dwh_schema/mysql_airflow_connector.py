...
with DAG(dag_id="mysql_airflow",default_args=default_args, schedule_interval='@once', tags=['mysql','connector', 'dwh']) as dag:
    
    pre_process = PythonOperator(
        task_id = "pre_process",
        python_callable = preprocess_df,
        op_kwargs={'path': '/home/Abuton/Desktop/ML_PATH/week0/dwh-techstack/data_store/I80_stations.csv'}
        )
